...
namespace CustodySystem.cls
{
    public class clscustody
    {
        ...
        public static Boolean checkCustodyNo(int custno)
        {
            try
            {
                DataTable dt = new DataTable();
                SqlDataAdapter da = new SqlDataAdapter("select * from Custody where Custody_ID=" + custno + " ", cls.GeneralClass.con);
                da.Fill(dt);
        ...
        public static Boolean NewCustody(int cno, string cname, DateTime addDate, int amount, string notes, DataTable SpecDT)
        {
            try
            {
                DataTable dt = new DataTable();
...
FROM            dbo.Custody INNER JOIN
        ...
        public static Boolean NewOrder(long No,DateTime dat,int empNo, int[] custNo)
        {
            try
            {
                DataTable dt = new DataTable();
